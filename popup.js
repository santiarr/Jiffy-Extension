...
removeElement('toggle');
  ...
  document.getElementById('content-opened').innerHTML = `<div id="gif-opened">
  ...
  <div id="opened-gif">
<a id="a-tag" href=${event.target.classList[2]} class = "opened-content-gif" style="background-color: rgb(16,16,16);"><img id="these-dimensions" class="opened-content-gif" src=${event.target.classList[1]}>
    </a>
  </div>
  <div id='wrapsidk'>
    <div id="gif-footer">
